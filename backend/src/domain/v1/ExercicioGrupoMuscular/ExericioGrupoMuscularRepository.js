const ExericioGrupoMuscularModel = require ('./ExericioGrupoMuscularModel')()

module.exports = (expressApp) => {
  class ExericioGrupoMuscularRepository {
    ...
    async find (params, fieldsToReturn = null, queryOptions = null) {
      ...
      return lista.map(model => {
        return Object.assign(new ExericioGrupoMuscularModel(), model.toJSON())
      })
    }

    async findByNome (nome) {
      const mongoose = await this._mongoose.findOne({nome})
      return mongoose ? Object.assign(new ExericioGrupoMuscularModel(), mongoose.toJSON()) : null
    }
    ...
    async create(registro) {
      ...
      return Object.assign(new ExericioGrupoMuscularModel(), mongoose.toJSON())
    }
  ...
  return ExericioGrupoMuscularRepository
}
