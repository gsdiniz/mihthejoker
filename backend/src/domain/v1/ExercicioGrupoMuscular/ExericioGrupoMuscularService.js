...
module.exports = (expressApp) => {
  class ExericioGrupoMuscularService {
    ...
    async _verifyNome (nome) {
      ...
      if (categoria) {
        throw new expressApp.helpers.error.NotAcceptable(`Grupo muscular já cadastrado => ${nome}`)
      }
    }
  }
  
  return ExericioGrupoMuscularService
}
